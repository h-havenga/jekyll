...
visited="ZA,BW,NA,GB,ZM,MW,NL,CH,FR,FI,DE,BE,LU,CZ,US,RE,US,AT,ES,AE,"
usa="US.NC,US.SC,US.NY,US.VA,US.WY,US.MO,US.SD,US.TN,US.WV,US.KS,US.CO,US.MA,US.GA,US.MI,US.AZ,US.KY,US.NJ,US.PA,US.TX,US.DC,US.OR,US.ID,US.MS,US.CA,US.NE,US.NM,US.AL,US.IL,US.AL,US.LA,US.IA,US.MD,US.ND,US.OK,US.MN,US.FL"
...
# North America
gmt pscoast -R-130/-70/24/52 -JL-100/35/33/45/24c -X-12 -Y-17 -B10a0 -Dh -E$usa+p0.25p,black+g100/255/100 -N1/0.5p,black -Glightgrey -O >> travelmap_world.ps

# Convert to png
gmt psconvert travelmap_world.ps -A -P -Tg
