...
gmt grdclip cape3_org.nc -Sb250/NaN -V -Gcape3_org.nc 
gmt grdclip cape2_org.nc -Sb250/NaN -V -Gcape2_org.nc 
...
gmt psbasemap  -Rg -JG25/-20/40 -X3 -Y3 -Bag --PS_MEDIA=50.94cx80.41c -K > $out
gmt makecpt    -Crainbow -T200/2550/100 -Z > cape.cpt
gmt psscale    -Ccape.cpt -D6.5c/0.5c+w12c/0.5c+jTC+h -Bxaf+l"CAPE J/Kg" -O -K >> $out
gmt makecpt    -Cglobe -T-10000/10000/100 -Z > topo.cpt
gmt grdimage    $topo -R -J -O -K -Ctopo.cpt >> $out
gmt pscoast    -R -J -Na -W -I1/0.25p,skyblue3 -I2/0.25p,skyblue3 -O -K >> $out
gmt grdimage    cape_mean.nc -R -J -Ccape.cpt -Q -O -K >> $out 
gmt pscoast    -R -J -N1 -W -B -O -K -Lx7.5/-2+c-26.5+w4500k+f >> $out
gmt grdcontour -W0,-- mslp_mean.nc -S4 -R -J -C2 -A2+f12 -T+lLH -O -K >> $out
gmt grdcontour -W1.7 zg500_mean.nc -A100+f18 -R -J -C100 -P -O -Gn1 -K >> $out
...
gmt grdimage    $topo -R -JM -O -K -Ctopo.cpt >> $out
gmt pscoast    -R -JM -Na -W -I1/0.25p,skyblue3 -I2/0.25p,skyblue3 -O -K >> $out
gmt grdimage   cape5_org.nc -R -J -Ccape.cpt -Q -O -K >> $out 
gmt grdcontour -W0,-- mslp5_nrm.nc -S4 -R -J -C2 -A2+f12 -T+lLH -O -K >> $out
gmt grdcontour -W1.7 zg5005_nrm.nc -A150+f16 -R -J -C150 -P -O -Gn1 -K >> $out
gmt psxy       ZAF_adm1.gmt -R -J -K -O -W0.05 -V >> $out
echo "34 -34 19/10/2011" | gmt pstext -R -JM -O -K -F+jTR+f16 -T -Gwhite -W1p -Dj0.1 >> $out

gmt psbasemap  -R15/34/-36/-21 -JM10 -Bn -Y10 -O -K >> $out
gmt grdimage    $topo -R -JM -O -K -Ctopo.cpt >> $out
gmt pscoast    -R -JM -Na -W -I1/0.25p,skyblue3 -I2/0.25p,skyblue3 -O -K >> $out
gmt grdimage   cape4_org.nc -R -J -Ccape.cpt -Q -O -K >> $out 
gmt grdcontour -W0 mslp4_nrm.nc -S4 -R -J -C2 -A2+f12 -O -T+lLH -K >> $out
gmt grdcontour -W1.7 zg5004_nrm.nc -A150+f16 -R -J -C150 -P -O -Gn1 -K >> $out
gmt psxy       ZAF_adm1.gmt -R -J -K -O -W0.05 -V >> $out
echo "34 -34 08/11/2012" | gmt pstext -R -JM -O -K -F+jTR+f16 -T -Gwhite -W1p -Dj0.1 >> $out

gmt psbasemap  -R15/34/-36/-21 -JM10 -Bn -X11 -Y0 -O -K >> $out
gmt grdimage    $topo -R -JM -O -K -Ctopo.cpt >> $out
gmt pscoast    -R -JM -Na -W -I1/0.25p,skyblue3 -I2/0.25p,skyblue3 -O -K >> $out
gmt grdimage   cape3_org.nc -R -J -Ccape.cpt -Q -O -K >> $out 
gmt grdcontour -W0 mslp3_nrm.nc -S4 -R -J -C2 -A2+f12 -T+lLH -O -K >> $out
gmt grdcontour -W1.7 zg5003_nrm.nc -A150+f16 -R -J -C150 -P -O -Gn1 -K >> $out
gmt psxy       ZAF_adm1.gmt -R -J -K -O -W0.05 -V >> $out
echo "34 -34 09/11/2012" | gmt pstext -R -JM -O -K -F+jTR+f16 -T -Gwhite -W1p -Dj0.1 >> $out

gmt psbasemap  -R15/34/-36/-21 -JM10 -Bn -X-11 -Y10 -O -K >> $out
gmt grdimage    $topo -R -JM -O -K -Ctopo.cpt >> $out
gmt pscoast    -R -JM -Na -W -I1/0.25p,skyblue3 -I2/0.25p,skyblue3 -O -K >> $out
gmt grdimage   cape2_org.nc -R -J -Ccape.cpt -Q -O -K >> $out 
gmt grdcontour -W0 mslp2_nrm.nc -S4 -R -J -C2 -A2+f12 -T+lLH -O -K >> $out
gmt grdcontour -W1.7 zg5002_nrm.nc -A150+f16 -R -J -C150 -P -O -Gn1 -K >> $out
gmt psxy       ZAF_adm1.gmt -R -J -K -O -W0.05 -V >> $out
echo "34 -34 11/11/2013" | gmt pstext -R -JM -O -K -F+jTR+f16 -T -Gwhite -W1p -Dj0.1 >> $out

gmt psbasemap  -R15/34/-36/-21 -JM10 -Bn -X11 -Y0 -O -K >> $out
gmt grdimage    $topo -R -JM -O -K -Ctopo.cpt >> $out
gmt pscoast    -R -JM -Na -W -I1/0.25p,skyblue3 -I2/0.25p,skyblue3 -O -K >> $out
gmt grdimage   cape_org.nc -R -J -Ccape.cpt -Q -O -K >> $out 
gmt grdcontour -W0 mslp_nrm.nc -S4 -R -J -C2 -A2+f12 -T+lLH -O -K >> $out
gmt grdcontour -W1.7 zg500_nrm.nc -A150+f16 -R -J -C150 -P -O -Gn1 -K >> $out
gmt psxy       ZAF_adm1.gmt -R -J -K -O -W0.05 -V >> $out
echo "34 -34 28/11/2013" | gmt pstext -R -JM -O -K -F+jTR+f16 -T -Gwhite -W1p -Dj0.1 >> $out
